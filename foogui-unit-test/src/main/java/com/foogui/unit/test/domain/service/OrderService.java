package com.foogui.unit.test.domain.service;

import com.foogui.unit.test.domain.entity.Order;
import com.foogui.unit.test.domain.service.specification.OrderSpecification;
import com.foogui.unit.test.domain.service.strategy.OrderStrategy;
